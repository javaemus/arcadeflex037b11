 ...
 /* background tiles */
            ...
            for (i = 0; i < TOTAL_COLORS(2); i++) {
                ...
                if ((c & 0x80) != 0) {
                    ...
                    colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + i] = (char) (0x80); /* transparent */
                }
            ...
            for (i = 0; i < TOTAL_COLORS(0); i++) {
                if (i % 2 == 0) {
                    colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] = (char) (0x80);  /* transparent */
                } else {
